...
if (!empty($_POST)) {
	...
	//$to = 'krotovstudio@gmail.com';
	$to = 'maxon.pro2015@gmail.com';

	$subject = 'LEAD FROM KrotovLP';
...
$headers .= "From: Admin <wordpress@myportfolio-demo.besaba.com>\r\n";
